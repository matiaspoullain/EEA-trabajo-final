...
*target: Variable respuesta que es linealmente dependiente de var1 tal que $E(Y/X)  = 3 + 2.var1$ y $\epsilon_{i} \sim N(0,4^2)$
```{r}
...
Ajustemos el modelo lineal $E(Y/X)  = \beta_{0} + \beta_{1}.var1$ y $\epsilon_{i} \sim N(0,\sigma^2)$ y veamos sus supuestos. Este modelo será llamado "modelo.bien":
